...
public readonly struct Complex(double r = 0, double i = 0) : INumber<Complex> {
	...
	public string ToString(int d) {
		string i = INumber<Complex>._sr(I, d), r = INumber<Complex>._sr(R, d);
		return r == "0" ? i == "0" ? "0" : INumber<Complex>._i(i, "i") : i == "0" ? r : r + " + " + INumber<Complex>._i(i, "i");
	}
	#endregion
	...
	#region Basics
	public static bool Compare(Complex a, Complex b) => a.R == b.R && a.I == b.I;
	// conjugate: a - bi
	...
	// from angle
	public static Complex IArg(double p, Complex _) => new(Math.Cos(p), Math.Sin(p));
	// square root
	...
	public static Complex Min(Complex a, Complex b) => new(double.IsNaN(a.R) ? a.R : Math.Min(a.R, b.R), double.IsNaN(a.I) ? a.I : Math.Min(a.I, b.I));
	public static Complex Max(Complex a, Complex b) => new(double.IsNaN(a.R) ? a.R : Math.Min(a.R, b.R), double.IsNaN(a.I) ? a.I : Math.Min(a.I, b.I));
	public static Complex Clamp(Complex c, Complex min, Complex max) => new(double.IsNaN(c.R) ? c.R : Math.Clamp(c.R, min.R, max.R), double.IsNaN(min.I) ? min.I : Math.Clamp(c.I, min.I, max.I));
	#endregion
	...
	// complex + imaginary
	public static Complex AddNV(Complex c, double i) => new(c.R, c.I + i);
	// imaginary + complex
	public static Complex AddNV(double i, Complex c) => new(c.R, c.I + i);
	#endregion
	...
	// complex - imaginary
	public static Complex SubNV(Complex c, double i) => new(c.R, c.I - i);
	// imaginary - complex
	public static Complex SubNV(double i, Complex c) => new(-c.R, i - c.I);
	#endregion
	...
	public static Complex operator %(Complex a, Complex b) => new(b.R == 0 ? double.NaN : a.R % b.R, b.I == 0 ? double.NaN : a.I % b.I);
	...
	// e ^ complex
	public static Complex Exp(Complex c) => Math.Exp(c.R) * IArg(c.I, new());
	...
	// i ^ complex
	public static Complex PowI(Complex c) => Exp(new(-c.I * INumber<Complex>.qTau, c.R * INumber<Complex>.qTau));
	#endregion
	...
	public static Complex Acosh(Complex c) => INumber<Complex>.IAcosh(c);
	public static Complex Asinh(Complex c) => INumber<Complex>.IAsinh(c);
	public static Complex Atanh(Complex c) => INumber<Complex>.IAtanh(c);
	public static Complex Acoth(Complex c) => INumber<Complex>.IAcoth(c);
	#endregion

	#region ArcTrigonometrics
	public static Complex Acos(Complex c) => INumber<Complex>.IAcos(c);
	public static Complex Asin(Complex c) => INumber<Complex>.IAsin(c);
	public static Complex Atan(Complex c) => INumber<Complex>.IAtan(c);
	public static Complex Acot(Complex c) => INumber<Complex>.IAcot(c);
	#endregion

	#region Exotic Trigonometrics
	// -i*((-1)^c - (-1)^(-c)) = 2sin(πc)
	public static Complex SinN1(Complex c) {
	...
	// -i * ((i)^c - (i)^(-c)) = 2sin(πc/2)
	public static Complex NISinI(Complex c) {
		double i = c.I * INumber<Complex>.qTau, r = c.R * INumber<Complex>.qTau, cos = Math.Cos(r), sin = Math.Sin(r), e = Math.Exp(i), ie = Math.Exp(-i);
